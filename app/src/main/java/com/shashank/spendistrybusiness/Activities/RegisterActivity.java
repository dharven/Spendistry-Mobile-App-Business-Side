    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registerButton.setOnClickListener(view -> {
            ...
            if (firstNameString.equals("")) {
                ...
                new Handler().postDelayed(() -> firstNameField.setErrorEnabled(false), 1000);
                ...
                new Handler().postDelayed(() -> lastNameField.setErrorEnabled(false), 1000);

            } else if (emailString.equals("")) {
                emailField.setError("Email is required");
                scrollView.smoothScrollTo(0, emailField.getTop());
                new Handler().postDelayed(() -> emailField.setErrorEnabled(false), 1000);

            } else if (passwordString.equals("")) {
                passwordField.setError("Password is required");
                scrollView.smoothScrollTo(0, passwordField.getTop());
                new Handler().postDelayed(() -> passwordField.setErrorEnabled(false), 1000);
                ...
                new Handler().postDelayed(() -> panNumberField.setErrorEnabled(false), 1000);
                ...
                new Handler().postDelayed(() -> businessNameField.setErrorEnabled(false), 1000);
                ...
                if (passwordString.equals(confirmPasswordString)) {
                    ...
                    dialog.show();
                    otpField.setOnFinishListener(s -> {
                        authViewModel.verifyOTP(linearLayout, email.getText().toString(), Integer.parseInt(s)).observe(RegisterActivity.this, response -> {
                            if (response.equals("201")) {
                                ...
                                dialog1.show();
                                authViewModel.createAccount(linearLayout,emailString, passwordString).observe(RegisterActivity.this, auth -> {
                                    if (!auth.getEmail().equals("")) {
                                        ...
                                        authViewModel.createVendorData(new Vendor(firstNameString, lastNameString, emailString, businessNameString,
                                                ...
                                                cityString, stateString, tollFreeString, websiteString, "")).observe(RegisterActivity.this, vendor -> {
                                                    dialog1.dismiss();
